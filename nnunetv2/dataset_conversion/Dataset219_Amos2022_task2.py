...
if __name__ == '__main__':
    ...
    parser.add_argument('-input_folder', type=str, default='/home/cuiqi/model/nnUnet/data/AMOS',
    ...
    parser.add_argument('-d', required=False, type=int, default=3, help='nnU-Net Dataset ID, default: 3')
