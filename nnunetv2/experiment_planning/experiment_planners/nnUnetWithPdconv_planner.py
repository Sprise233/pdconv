...
class nnUnetWithPdconvPlanner(BasicPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'nnUnetWithPdconvPlans',
        ...
        self.UNet_blocks_per_stage_encoder = (2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
        self.UNet_blocks_per_stage_decoder = (2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
    ...
    def generate_data_identifier(self, configuration_name: str) -> str:
        ...
        if configuration_name == '3d_fullres':
            ...
            return 'nnUnetWithPdconvPlans' + '_' + configuration_name
        else:
    ...
    def get_plans_for_configuration(self,
        ...
        architecture_kwargs = {
            'network_class_name': "models.nnUnet_with_pdconv.architecture.PlainConvUNet",
            'arch_kwargs': {
                'n_stages': num_stages,
