...
class PDCNWithPDCDPlanner(BasicPDCNPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'PDCNWithPDCDPlans',
        ...
        self.network_class_name = "models.PDCN_with_PDCD.architecture.PDCN_with_PDCD"
