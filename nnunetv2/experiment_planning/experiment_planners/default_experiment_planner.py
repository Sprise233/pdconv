...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        if isfile(join(self.raw_dataset_folder, 'splits_final.json.json')):
            _maybe_copy_splits_file(join(self.raw_dataset_folder, 'splits_final.json.json'),
                                    join(preprocessed_folder, 'splits_final.json.json'))
...
if __name__ == '__main__':
    ExperimentPlanner(1, 16).plan_experiment()
