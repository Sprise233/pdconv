...
from torch.nn.quantized import _ConvNd

from models.nnUnet_with_pdconv.plain_conv_encoder import PlainConvEncoder
from models.nnUnet_with_pdconv.unet_decoder import UNetDecoder
...
class PlainConvUNet(nn.Module):
    def __init__(self,
        ...
        conv_op = nn.Conv3d
        self.encoder = PlainConvEncoder(input_channels, n_stages, features_per_stage, conv_op, strides,
...
if __name__ == '__main__':
    ...
    model = get_network_from_plans(arch_class_name='models.nnUnet_with_pdconv.architecture.PlainConvUNet',
                                   arch_kwargs={'n_stages': 6, 'features_per_stage': [32, 64, 128, 256, 320, 320],
                                                'strides': [[1, 1, 1], [1, 2, 2], [2, 2, 2], [2, 2, 2], [1, 2, 2],
                                                            [1, 2, 2]], 'n_conv_per_stage': [2, 2, 2, 2, 2, 2],
