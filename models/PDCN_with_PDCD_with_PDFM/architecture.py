...
from models.PDCN_with_PDCD_with_PDFM.blocks.decoder import Decoder
...
class PDCN_with_PDCD_with_PDFM(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
...
if __name__ == '__main__':
    ...
    model = get_network_from_plans(arch_class_name='models.PDCN_with_PDCD_with_PDFM.architecture.PDCN_with_PDCD_with_PDFM',
                                   arch_kwargs={'n_stages': 6, 'features_per_stage': [32, 64, 128, 256, 320, 320],
                                                'strides': [[1, 1, 1], [1, 2, 2], [2, 2, 2], [2, 2, 2], [1, 2, 2],
                                                            [1, 2, 2]], 'n_blocks_per_stage': [2, 1, 1, 1, 1, 1],
