...
if __name__ == '__main__':
    data = torch.rand((1, 1, 80, 256, 256))

    model = PlainConvUNet(1, 6, (32, 64, 125, 256, 320, 320), nn.Conv3d, 3, ((1, 1, 1), (1, 2, 2), (2, 2, 2), (2, 2, 2), (1, 2, 2), (1, 2, 2)), (2, 2, 2, 2, 2, 2), 4,
                                (2, 2, 2, 2, 2), False, nn.InstanceNorm3d, None, None, None, nn.ReLU, deep_supervision=True)
